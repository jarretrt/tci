...
<img src="examples_files/figure-gfm/plot-method-1.png" style="display: block; margin: auto;" />
...
<img src="examples_files/figure-gfm/plot-method-2.png" style="display: block; margin: auto;" />
...
TCI algorithm to multiple targets.
...
<!-- end list -->
  ...
  - The function should be left-continuous, such that each (time, Cet)
    combination defines the target at that time. The function will
    calculate infusions until the end of the time period defined.

<!-- end list -->

2.  Define update schedule (to extent possible). Define vector of tci
    evaluation times (if possible), infusion durations

<!-- end list -->

  - May require function for finding and maintaining a constant infusion
    rate (numerically? Since it may not be possible for any arbitrary PK
    model)
